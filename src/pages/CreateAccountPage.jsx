  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-white">
      <div className="bg-gray-50 w-66 min-h-screen flex flex-col justify-start p-4 shadow-md text-left">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 flex-1/2">
          {[
          ...
          <button
            type="submit"
            className="cursor-pointer w-full bg-violet-600 text-white font-medium py-2 rounded mt-26 text-xs mb-2"
          >
            Create Account
          </button>
        </form>
